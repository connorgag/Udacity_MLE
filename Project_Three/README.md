...
- The Hyperdrive model could be improved my adding different hyperparameters or changing their ranges. You could even go into train.py and change the algorithm entirely based on what performed well in the AutoML model. 
- In both the AutoML and Hyperdrive, I used normalized root mean squared error as the primary metric. Changing this to something else, such as R Squared, could yield better results for the models. 
